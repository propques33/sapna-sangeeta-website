  ...
  return (
    <div className="relative bg-gray-100 h-screen flex items-center justify-center">
      ...
      <div className="absolute inset-0">
        <img
          src="https://via.placeholder.com/1920x1080" // Replace with your background image URL
          alt="Coworking Space"
      ...
      <div className="absolute flex justify-between items-center w-full px-6 top-1/3">
        <img
          src="https://via.placeholder.com/200x150" // Replace with your image URL
          alt="Workspace 1"
          className="w-48 h-36 rounded-lg shadow-lg transform rotate-6"
        />
        <img
          src="https://via.placeholder.com/200x150" // Replace with your image URL
          alt="Workspace 2"
